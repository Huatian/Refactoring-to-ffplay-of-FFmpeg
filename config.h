...
#define FFMPEG_CONFIGURATION "--enable-shared --disable-yasm --enable-gpl --enable-avcodec --enable-avdevice --enable-avformat --enable-swresample --enable-swscale --enable-postproc --enable-avfilter --enable-avresample --enable-pthreads --enable-network --enable-dct --enable-dwt --enable-error-resilience --enable-lsp --enable-lzo --enable-mdct --enable-rdft --enable-fft --enable-faan --enable-pixelutils --enable-ffplay"
